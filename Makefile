...
SOURCES= MinuitFit.cpp LineFit.cpp UncorrelatedOpt.cpp Calibration3d.cpp CalibrationLayer3d.cpp Calibration2d.cpp CalibrationLayer2d.cpp SimpleCalibration.cpp Config.cpp main.cpp  Tree.cpp Start.cpp TOF.cpp Intermediate.cpp Fiber.cpp D1.cpp D2.cpp HEX.cpp DCLayer.cpp P349_data.cpp SingleEvent.cpp dictp349_data.cpp Hist.cpp EventDisplay.cpp CommonFunctions.cpp Fit3d.cpp
