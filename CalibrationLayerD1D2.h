 #ifndef CALIBRATIONLAYERD1D2_H
#define CALIBRATIONLAYERD1D2_H
...
struct D1D2_single_event_data3d
{
	double wire_pos_X;
	double wire_pos_Z;
	double hit_pos_X;
...
class CalibrationLayerD1D2
{
public:

	CalibrationLayerD1D2();
	CalibrationLayerD1D2(int _layer_no, const std::vector<double> &_CalibTimes, const std::vector<double> &_CalibDistances);
	~CalibrationLayerD1D2();
	...
	std::vector<D1D2_single_event_data3d> CalibrationData;
