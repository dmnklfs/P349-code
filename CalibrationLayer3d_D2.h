#ifndef CALIBRATIONLAYER3D_D2_H
#define CALIBRATIONLAYER3D_D2_H
...
class CalibrationLayer3d_D2
{
public:

	CalibrationLayer3d_D2();
	CalibrationLayer3d_D2(int _layer_no, const std::vector<double> &_CalibTimes, const std::vector<double> &_CalibDistances);
	~CalibrationLayer3d_D2();
	...
	std::vector<D2_single_event_data3d> CalibrationData;
