...
private:
	...
	bool unbiased_fit;
	// data for fit
	double x_straight_wires[2];
	double x_straight[2],  z_straight[2],  errors_straight[2];
	...
	TVector3 track3d_fit_point_unbiased[6], track3d_fit_vector_unbiased[6];
	...
	bool errflag;
	bool errflag_unbiased[6];

	double wire_track_dist[6];
	double chisq;
	double chisq_unbiased[6];
