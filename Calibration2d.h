#ifndef CALIBRATION2D_H
#define CALIBRATION2D_H
...
public:
	...
	Calibration2d();
	Calibration2d(const Config &_config);
	~Calibration2d();

	void get_data(data_for_D1_calibration _single_event_data);
	void tell_no_of_events();
	void solve_lr_ambiguity(const CalibrationLayer2d &layer1, const CalibrationLayer2d &layer2);
