...
struct data_for_D1_track_reco
{
	double positionsHitsX[8];
	double positionsZ[8];
	double drift_times[8];
	double errorsX[8];
};

struct data_for_D2_track_reco
{
	double positionsHitsX[6];
	double positionsZ[6];
	double drift_times[6];
	double errorsX[6];
};
...
{
	data_for_D1_track_reco D1;
	data_for_D2_track_reco D2;
	data_for_HEX_track_reco HEX;
};

// STRUCTS USED IN Hist CLASS
struct start_hist_data
{
	start_hist_data(std::vector<int>& _rough_elements_up, std::vector<int>& _rough_elements_down, std::vector<double>& _rough_time_up, std::vector<double>& _rough_time_down,std::vector<double>& _preselected_time_up, std::vector<double>& _preselected_time_down)
		: rough_elements_up(_rough_elements_up), rough_elements_down(_rough_elements_down), rough_time_up(_rough_time_up), rough_time_down(_rough_time_down), preselected_time_up(_preselected_time_up), preselected_time_down(_preselected_time_down) { }
	...
	std::vector<double> &rough_time_up;
	std::vector<double> &rough_time_down;
...
{
	DCLayer_hist_data(std::vector<int>& _rough_elements, std::vector<int>& _preselected_elements, std::vector<double>& _rough_times, std::vector<double>& _preselected_times, std::vector<double>& _tot, std::vector<double>& _distances_from_wire)
		: rough_elements(_rough_elements), preselected_elements(_preselected_elements), rough_times(_rough_times), preselected_times(_preselected_times), tot(_tot), distances_from_wire(_distances_from_wire) {}
