...
void Fit3d_HEX::calculate_xy_functions()
{
	...
	y_x_b[0][1] = 0;
	// inclined 1
	y_x_a[1] = -TMath::Tan(80*3.14*pow(180,-1));
	y_x_b[1][0] = -x_inclined1[0]*y_x_a[1];
	y_x_b[1][1] = -x_inclined1[1]*y_x_a[1];
	// inclined 2
	y_x_a[2] =  TMath::Tan(80*3.14*pow(180,-1));
...
void Fit3d_HEX::calculate_wires_xy_functions()
{
	...
	// inclined 2
	y_x_a_wire[2] = TMath::Tan(80*3.14*pow(180,-1));
...
void Fit3d_HEX::calculate_projections_on_hit_planes_calculations() // unused, expect from drawings
{
...
void Fit3d_HEX::calculate_projections_on_hit_planes_fit()
{
	double angle;
...
void Fit3d_HEX::draw_event()
{
	...
	inclined1_hit_plane->SetPoint(0, -TMath::Tan(10*3.141592654/180)*dc_half_height + (dc_z_min - z_x_b[1])*pow(z_x_a[1],-1), 0 - dc_half_height, dc_z_min);
	inclined1_hit_plane->SetPoint(1, +TMath::Tan(10*3.141592654/180)*dc_half_height + (dc_z_min - z_x_b[1])*pow(z_x_a[1],-1), 0 + dc_half_height, dc_z_min);
	inclined1_hit_plane->SetPoint(2, +TMath::Tan(10*3.141592654/180)*dc_half_height + (dc_z_max - z_x_b[1])*pow(z_x_a[1],-1), 0 + dc_half_height, dc_z_max);
	inclined1_hit_plane->SetPoint(3, -TMath::Tan(10*3.141592654/180)*dc_half_height + (dc_z_max - z_x_b[1])*pow(z_x_a[1],-1), 0 - dc_half_height, dc_z_max);
	inclined1_hit_plane->SetPoint(4, -TMath::Tan(10*3.141592654/180)*dc_half_height + (dc_z_min - z_x_b[1])*pow(z_x_a[1],-1), 0 - dc_half_height, dc_z_min);
	...
	inclined2_hit_plane->SetPoint(0,  TMath::Tan(10*3.141592654/180)*dc_half_height + (dc_z_min - z_x_b[2])*pow(z_x_a[2],-1), 0 - dc_half_height, dc_z_min);
	inclined2_hit_plane->SetPoint(1, -TMath::Tan(10*3.141592654/180)*dc_half_height + (dc_z_min - z_x_b[2])*pow(z_x_a[2],-1), 0 + dc_half_height, dc_z_min);
	inclined2_hit_plane->SetPoint(2, -TMath::Tan(10*3.141592654/180)*dc_half_height + (dc_z_max - z_x_b[2])*pow(z_x_a[2],-1), 0 + dc_half_height, dc_z_max);
	inclined2_hit_plane->SetPoint(3,  TMath::Tan(10*3.141592654/180)*dc_half_height + (dc_z_max - z_x_b[2])*pow(z_x_a[2],-1), 0 - dc_half_height, dc_z_max);
	inclined2_hit_plane->SetPoint(4,  TMath::Tan(10*3.141592654/180)*dc_half_height + (dc_z_min - z_x_b[2])*pow(z_x_a[2],-1), 0 - dc_half_height, dc_z_min);
	...
	normal_i1->SetPoint(0, -TMath::Tan(10*3.141592654/180)*dc_half_height + (dc_z_min - z_x_b[1])*pow(z_x_a[1],-1), 0 - dc_half_height, dc_z_min);
	normal_i1->SetPoint(1, -TMath::Tan(10*3.141592654/180)*dc_half_height + (dc_z_min - z_x_b[1])*pow(z_x_a[1],-1)+scale*normal_inclined1.X(), 0 - dc_half_height+scale*normal_inclined1.Y(), dc_z_min+scale*normal_inclined1.Z());
	normal_i1->SetLineWidth(3);
	normal_i1->SetLineColor(color[1]);

	TPolyLine3D *in1_i1 = new TPolyLine3D(2);
	in1_i1->SetPoint(0, -TMath::Tan(10*3.141592654/180)*dc_half_height + (dc_z_min - z_x_b[1])*pow(z_x_a[1],-1), 0 - dc_half_height, dc_z_min);
	in1_i1->SetPoint(1, -TMath::Tan(10*3.141592654/180)*dc_half_height + (dc_z_min - z_x_b[1])*pow(z_x_a[1],-1)+scale*xz_inclined1[0], 0 - dc_half_height, dc_z_min+scale*xz_inclined1[2]);
	in1_i1->SetLineWidth(3);
	in1_i1->SetLineColor(color[0]);

	TPolyLine3D *in2_i1 = new TPolyLine3D(2);
	in2_i1->SetPoint(0, -TMath::Tan(10*3.141592654/180)*dc_half_height + (dc_z_min - z_x_b[1])*pow(z_x_a[1],-1), 0 - dc_half_height, dc_z_min);
	in2_i1->SetPoint(1, -TMath::Tan(10*3.141592654/180)*dc_half_height + (dc_z_min - z_x_b[1])*pow(z_x_a[1],-1)+scale*xy_inclined1[0], 0 - dc_half_height+scale*xy_inclined1[1], dc_z_min+scale*xy_inclined1[2]);
	in2_i1->SetLineWidth(3);
	in2_i1->SetLineColor(kRed);

	TPolyLine3D *normal_i2 = new TPolyLine3D(2);
	normal_i2->SetPoint(0,  TMath::Tan(10*3.141592654/180)*dc_half_height + (dc_z_min - z_x_b[2])*pow(z_x_a[2],-1), 0 - dc_half_height, dc_z_min);
	normal_i2->SetPoint(1,  TMath::Tan(10*3.141592654/180)*dc_half_height + (dc_z_min - z_x_b[2])*pow(z_x_a[2],-1)+scale*normal_inclined2.X(), 0 - dc_half_height+scale*normal_inclined2.Y(), dc_z_min+scale*normal_inclined2.Z());
