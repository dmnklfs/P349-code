#ifndef CALIBRATIONLAYER3D_HEX_H
#define CALIBRATIONLAYER3D_HEX_H
...
struct HEX_single_event_data3d
{
	double wire_pos_X;
	double wire_pos_Z;
	double hit_pos_X;
...
class CalibrationLayer3d_HEX
{
public:

	CalibrationLayer3d_HEX();
	CalibrationLayer3d_HEX(int _layer_no, const std::vector<double> &_CalibTimes, const std::vector<double> &_CalibDistances);
	~CalibrationLayer3d_HEX();
	...
	std::vector<HEX_single_event_data3d> CalibrationData;
