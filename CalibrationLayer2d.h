#ifndef CALIBRATIONLAYER2D_H
#define CALIBRATIONLAYER2D_H
...
class CalibrationLayer2d
{
public:

	CalibrationLayer2d();
	CalibrationLayer2d(int _layer_no, const std::vector<double> &_CalibTimes, const std::vector<double> &_CalibDistances);
	~CalibrationLayer2d();
	...
	std::vector<D1_single_event_data2d> CalibrationData;
